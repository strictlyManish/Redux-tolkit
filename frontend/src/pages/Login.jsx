      ...
      <div className="w-full sm:w-3/4 lg:w-2/4 flex flex-col gap-4 p-6 sm:p-8 lg:p-25">
        <form>
          ...
          <div className="flex flex-col gap-2">
            ...
            <input className="p-3 bg-gray-700 outline-0 rounded" type="text" id="password" placeholder="Password" />
          </div>
          <br />
          <button className="bg-blue-700 w-full p-3 rounded cursor-pointer text-sm sm:text-base font-medium active:bg-pink-600">Login</button>
        </form>
